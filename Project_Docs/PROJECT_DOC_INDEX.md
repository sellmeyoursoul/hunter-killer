...
| [Draft_Features/COMBAT.md](Draft_Features/COMBAT.md) | **Melee combat:** contact detection, damage vs. point pools (`stat_to_point`), `tactic_fight_active` motor flag, salient write on outcome; **implementation gated on [CREATURE_MOVEMENT_V3](Draft_Features/CREATURE_MOVEMENT_V3) shipping**; also depends on **[SHARED_STATTOPOINT_PLAN.md](Draft_Features/SHARED_STATTOPOINT_PLAN.md)**. |
