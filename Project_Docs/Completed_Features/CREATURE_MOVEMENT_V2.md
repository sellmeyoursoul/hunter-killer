...
> **Archived (2026-06-20 — V3 refactor Step 1):** Superseded by **[CREATURE_MOVEMENT_V3.md](../Draft_Features/CREATURE_MOVEMENT_V3.md)** — greenfield ENGINE motor (`creature_motor_v3`, hub / planner / facing-relative execution). **Snapshot** — documents V2 `creature_motor` / `MotorContext` / cardinal pipeline still in code until §12 Step 3 teardown. Drift vs implementation expected during refactor. Not authoritative unless a task explicitly cites this archive.
>
> **Sibling contracts (archived paths):** motivation tree — **[../Draft_Features/CREATURE_GOAL_DRIVERS.md](../Draft_Features/CREATURE_GOAL_DRIVERS.md)**; beliefs — **[../Draft_Features/CREATURE_MEMORY.md](../Draft_Features/CREATURE_MEMORY.md)**; POST_LOS planner — **[POST_LOS_MOVEMENT.md](POST_LOS_MOVEMENT.md)** (Phase **4.5**, also archived).
>
