...
- Follow root [CLAUDE.md](../../CLAUDE.md) GDScript formatting rules and align with `Project_Docs/Definitive_Features/CREATURE_3D_ARCHITECTURE.md` for scene graph and intent API contracts.
...
- Flag the caller for doc sync (via `project-docs`) when public definition fields, template paths, or trait/stat usage maps change.
