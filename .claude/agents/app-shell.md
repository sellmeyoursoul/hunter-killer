...
- Follow [oLog_lib/CLAUDE.md](../../oLog_lib/CLAUDE.md) when changing OLog config consumption paths.
- Flag the caller for doc sync (`project-docs`) when autoload paths, main scene, or resolver tag contracts change.
